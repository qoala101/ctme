...
void Test2Vectors() {
  ...
  std::cout << expression.GetRow<0>().GetCol<0>().GetVal<1>(a_values, b_values)
            << "\n";
  std::cout << expression.GetRow<0>().GetCol<1>().GetVal<1>(a_values, b_values)
            << "\n";
  std::cout << expression.GetRow<1>().GetCol<0>().GetVal<1>(a_values, b_values)
            << "\n";
  std::cout << expression.GetRow<1>().GetCol<1>().GetVal<1>(a_values, b_values)
            << "\n";

  assert(expression.GetRow<0>().GetCol<0>().GetVal<1>(a_values, b_values) == 832);
  assert(expression.GetRow<0>().GetCol<1>().GetVal<1>(a_values, b_values) == 868);
  assert(expression.GetRow<1>().GetCol<0>().GetVal<1>(a_values, b_values) == 1039);
  assert(expression.GetRow<1>().GetCol<1>().GetVal<1>(a_values, b_values) == 1084);
}
...
// void f(const Args &...args, const T &t) {
//   f(args...);
// }
...
struct A {
  ...
  static void f(const Args &...args) {
    std::cout << std::get<ContainerIndex>(std::tie(args...));
    A<ContainerIndex - 1>::f(args...);
  }
};
